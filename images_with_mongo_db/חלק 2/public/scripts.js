$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (Array.isArray(response)) {
                    ...
                    const projects = response.sort((a, b) => new Date(b.start_date) - new Date(a.start_date));
                    ...
                    const projectList = projects.map(project => `
                        <tr>
                            ...
                            <td>
                                <button class="editProjectBtn" data-id="${project._id}">Edit</button>
                                <button class="deleteProjectBtn" data-id="${project._id}">Delete</button>
                                <button class="addImageBtn" data-id="${project._id}">Add Image</button>
                                <button class="viewImagesBtn" data-id="${project._id}">View Images</button>
                            </td>
                        </tr>
                    `).join('');
    ...
    $('#imageForm').submit(function(event) {
        ...
        const imageData = {
            thumb_url: selectedImage.thumb_url, // Ensure thumb_url is sent
